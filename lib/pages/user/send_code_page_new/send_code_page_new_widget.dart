...
import 'send_code_page_new_model.dart';
export 'send_code_page_new_model.dart';

class SendCodePageNewWidget extends StatefulWidget {
  const SendCodePageNewWidget({
    super.key,
  ...
  @override
  State<SendCodePageNewWidget> createState() => _SendCodePageNewWidgetState();
}

class _SendCodePageNewWidgetState extends State<SendCodePageNewWidget> {
  late SendCodePageNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SendCodePageNewModel());
