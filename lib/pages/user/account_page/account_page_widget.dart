      ...
      if (FFAppState().goodLogin == true) {
        ...
        FFAppState().update(() {
          FFAppState().updateBasketMainStruct(
            (e) => e
              ..userIdSUL = FFAppState().userIDsul
              ..cardIdSUL = FFAppState().cardid,
          );
        });
  ...
  Widget build(BuildContext context) {
    ...
    return Title(
        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            key: scaffoldKey,
            backgroundColor: FlutterFlowTheme.of(context).fonTravel,
            appBar: AppBar(
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                height: 250.0,
                                decoration: BoxDecoration(
                                  color: FlutterFlowTheme.of(context).fonTravel,
                                  borderRadius: BorderRadius.circular(0.0),
                                ),
                                child: FutureBuilder<ApiCallResponse>(
                                  future: FFAppState().getActionsQuery(
                                    uniqueQueryKey: FFAppState().cardid,
                                    requestFn: () =>
                                        ApiSulGroup.getActionsCall.call(),
                                  ),
                                  builder: (context, snapshot) {
                                    ...
                                    final listViewGetActionsResponse =
                                        snapshot.data!;
                                    return Builder(
                                      builder: (context) {
                                        final actionsArray = getJsonField(
                                          listViewGetActionsResponse.jsonBody,
                                          r'''$.actions''',
                                        ).toList();
                                        return ListView.builder(
                                          ...
                                          itemCount: actionsArray.length,
                                          itemBuilder:
                                              (context, actionsArrayIndex) {
                                            final actionsArrayItem =
                                                actionsArray[actionsArrayIndex];
                                            return InkWell(
                      ...
                      child: Material(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              color: FlutterFlowTheme.of(context).mainFon,
                              width: 1.0,
                            ),
                          ),
                          child: Align(
